...
if __name__=="__main__":
    ...
    if mode.lower() == "server":
        ...
        echoServerEndpoint = GateServerEndpoint.CreateFromConfig(reactor, 101, gateKey, networkStack=RipStackAuthentication)
        ...
        echoClientEndpoint = GateClientEndpoint.CreateFromConfig(reactor, echoServerAddr, 101, gateKey, networkStack=RipStackAuthentication)
